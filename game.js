...
var score = 0;
var misses = 0;
var maxMisses = 0;   // <-- KODE ASLI: Nilainya 0
var gameOver = false;
...
    
    // <-- KODE ASLI: Ini adalah blok 'if' yang bermasalah
    if (misses >= maxMisses) {
        gameOver = true;
        gameOverSound.play();
        
...
Read     ctx.font = "bold 9px Joystix";
    ctx.fillStyle = "black";
